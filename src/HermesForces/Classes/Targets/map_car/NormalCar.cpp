...
NormalCar::NormalCar(const int& idTag,const cocos2d::Point& p) : IUnit(idTag,p)
{
	_targetUnit = Sprite::createWithSpriteFrameName(MapProcessor::Instance()->getPathRandomItemNotLoopWithIndex(false,_indexAnime));
