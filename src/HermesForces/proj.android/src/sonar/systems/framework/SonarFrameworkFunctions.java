...
public class SonarFrameworkFunctions 
{
	...
	public static int GetDeviceSize()
	{
		...
		((SonarFrameworkActivity) app).getWindowManager().getDefaultDisplay().getMetrics(metrics);
...
//		double pixelInch = 0.01 *  diagonalInches;
//		int miniPxl = 	(int)pixelInch * (dint)widthDpi;
//		return miniPxl;
		
		if (diagonalInches <= 5.7) {
		    //Device is a 7" tablet
			//Toast.makeText(((SonarFrameworkActivity) app), " phone " + diagonalInches, Toast.LENGTH_LONG).show();				
			return 1;
		}
		else if (diagonalInches >= 8.0) {
		    //Device is a 10" tablet
			//Toast.makeText(((SonarFrameworkActivity) app), "tablet 10.0 " + diagonalInches, Toast.LENGTH_LONG).show();
			return 3;
		}
		else {
		    //Device is a 7" tablet
			//Toast.makeText(((SonarFrameworkActivity) app), "tablet 7 inch " + diagonalInches, Toast.LENGTH_LONG).show();
			return 2;
		}
